...
namespace Tessera
{
    ...
    public static class MeshUtils
    {
        ...
        /// </summary>
        internal static MeshDeformation GetDeformation(TesseraGenerator generator, MeshData surfaceMesh, TesseraTileInstance i)
        {
            return GetDeformation(surfaceMesh, generator.tileSize.y, generator.surfaceOffset, generator.surfaceSmoothNormals, i);
        }
